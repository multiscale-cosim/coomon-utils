...
class ResourceUsageMonitor:
    ...
    However, it can be extended easily also to support monitroing of other
    resource usage.
    '''
    def __init__(self, log_settings,
        ...
        self.__process = Process(log_settings=self._log_settings,
                                 ...
                                 pid=self.process_id)
        # flag to stop monitoring to be set by Applicaiton Manager
    ...
    def start_monitoring(self):
        ...
        This ensures the extensibility to add more resources to be monitroed
        as monitoring jobs.
        '''
