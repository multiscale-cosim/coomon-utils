...
class ApplicationCompanion(multiprocessing.Process):
    ...
    def __init__(self, log_settings, configurations_manager,
        ...
        self.__aplication_companion_response_queue = ac_response_queue
        ...
        self.__logger.debug("Application Companion is initilized")
    ...
    def __get_event(self, event_queue):
        ...
        while True:
            ...
            if self.__stop_event.is_set() or self.__kill_event.is_set():
                ...
                self.__aplication_companion_response_queue.put(
                                           Response.ERROR)
                break
            else:
                try:
        ...
        while True:
            ...
            if self.__stop_event.is_set() or self.__kill_event.is_set():
                ...
                if(current_steering_command == SteeringCommands.START.value):
                    ...
                    self.__aplication_companion_response_queue.put(
                                                            Response.OK)
                    # indicate the enqued task (command)
