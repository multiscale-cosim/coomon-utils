...
if __name__ == '__main__':
    """
    Entry point to laucnh the application companion
    ...
    # get path to application to be exeuted
    ...
    applicaiton_companion_response_queue = multiprocessing.Queue()
    ...
    application_companion = ApplicationCompanion(
                                ...
                                applicaiton_companion_response_queue)
    ...
    get_response(minimum_delays, applicaiton_companion_response_queue)
    ...
    get_response(response_codes, applicaiton_companion_response_queue)
